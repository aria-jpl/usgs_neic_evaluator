...
def main(event_polygon):
    ...
    for product in products['products']:
        ...
        count = count + 1
    print(tracks.items())
    print("Number of acqs " + str(count))
    ...
    print("Done with diplacement calculator:")
    print(track_data)
...
def getAcqInfo(product):
    try:
        ...
        print("Failed to parse acquisition metadata for: ")
        print(product)
